...
return array(
    ...
    "The input is an empty string" => 'مقدار این فیلد مورد نیاز است و نمیتواند خالی باشد.',

    // Zend\I18n\Validator\Alpha
    "Invalid type given. String expected" => 'نوع ورودی باید از نوی متنی باشد',
    "The input contains non alphabetic characters" => 'لطفا فقط از حروف استفاده نمایید.',
    ...
    "The input does not match a phone number format" => 'شماره تلفن وارد شده صحیح نمی باشد.',
    ...
    // Zend\Validator\Csrf
    "The form submitted did not originate from the expected site" => 'فرم ثبت شده از سایت مبدا معتبر ثبت نشده است.',
    ...
    "The input is not a valid email address. Use the basic format local-part@hostname" => 'آدرس ایمیل معتبر نمی باشد.',
    ...
    "Maximum allowed width for image should be '%maxwidth%' but '%width%' detected" => "بیشترین پیکسل برای عرض تصویر '%maxwidth%' می باشد ، اما عرض تصویر شما '%width%' می باشد .",
    ...
    "Maximum allowed height for image should be '%maxheight%' but '%height%' detected" => "بیشترین پیکسل برای ارتفاع تصویر '%maxheight%' می باشد ، اما ارتفاع تصویر شما '%height%' می باشد .",
    ...
    "Maximum allowed size for file is '%max%' but '%size%' detected" => "بیشترین حجم مجاز برای آپلود فایل '%max%' می باشد ، اما حجم فایل آپلودی شما '%size%' می باشد .",
    ...
    "The input was not found in the haystack" => 'مقدار این فیلد مورد نیاز است.',
    ...
    "Value is required and can't be empty" => 'مقدار این فیلد مورد نیاز است.',
    ...
    "The input is less than %min% characters long" => 'متن ورودی حداقل %min% کاراکتر میتواند باشد',
    "The input is more than %max% characters long" => 'متن ورودی حداکثر میتواند %max% کاراکتر باشد.',
