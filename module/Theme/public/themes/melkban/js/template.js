...
$(document).ready(function () {
    ...
    $('.img_statistic').click(function (e) {
        e.preventDefault();
        if ($('.box_statistic').hasClass('show')) {
            $('.box_statistic').animate({left: "-=240"}, 600).removeClass('show');
        } else {
            $('.box_statistic').animate({left: "+=240"}, 600).addClass('show');
        }
        // }
    });
