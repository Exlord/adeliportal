...
//                    $('#addressShort').removeClass('error');
            ...
            case 2:
                ...
                break;
            case 3 :
                $('.txt_1').html($(':selected', $('#estateType')).html());
                $('.txt_2').html($(':selected', $('#regType')).html());
                $('.txt_3').html($('#transferFields_zirbana').val());
                $('.txt_4').html($('#transferFields_masahate_zamin').val());
                $('.txt_5').html($(':selected', $('#cityId')).html());
                $('.txt_6').html($(':selected', $('#areaId')).html());
                break;
            case 4:
