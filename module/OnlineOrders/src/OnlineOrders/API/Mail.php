...
*	Modified Lastmod : Apr 2008
*	Modified Version : 1.6.1 (php5)
*
...
class Mail
{
                              ...
                              $replytoname = "")
    {
        ...
        $mail = new \OnlineOrders\API\Mail();
        ...
        $mail->Html($message);
        $mail->Organization($settings['organization']);
        $mail->ReturnPath($settings['adminEmail'], $settings['organization'] . " Support");
        $mail->SetCharset($charset);
        $mail->Priority($Priority); // set the priority to Low
        $mail->Receipt(); //قبض رسید
